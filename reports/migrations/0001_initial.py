# Generated by Django 3.2.2 on 2021-05-27 14:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('venue', models.ManyToManyField(through='reports.Course_Venue', to='reports.Venue')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.lecturer'),
        ),
        migrations.AddField(
            model_name='course_venue',
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.ue'),
        ),
        migrations.AddField(
            model_name='course_venue',
            name='venue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.venue'),
        ),
        migrations.AddField(
            model_name='course',
            name='program',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criteria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assessment', to='reports.ca_item')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.ca_item')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Assessment_Questions_Results',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(100)])),
                ('total_score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(100)])),
                ('question_number', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)])),
                ('assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='result', to='reports.assessment_criteria')),
